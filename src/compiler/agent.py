...
"""Agent and states for the AlphaTensor-Quantum compile."""
...
class Agent:
  ...
  def __init__(self, config: compile_config.CompileConfig):
    """Initializes the agent.

    Args:
      config: The config hyperparameters for the compile.
    """
